...
/// Protobuf `crypto.pb.PublicKey`: field1 KeyType=2 (Ed25519), field2 Data=key bytes.
pub fn marshalPublicKeyEd25519(pub32: *const [32]u8) [38]u8 {
    var out: [38]u8 = undefined;
    // field 1: varint 2 (Ed25519)
    out[0] = 0x08;
    out[1] = 0x02;
